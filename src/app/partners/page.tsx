      ...
      <section className="relative overflow-hidden pt-36 pb-20 lg:pt-48 lg:pb-28 bg-[linear-gradient(180deg,#FBF9FF_0%,#FFFFFF_40%,#FBF9FE_100%)]">
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-5xl text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg sm:text-xl text-slate-600 leading-relaxed mb-10">
            Join our certified partner network. Deliver autonomous campaign intelligence to your clients and earn recurring revenue share while eliminating delivery burnout.
          </p>
        ...
        <div className="container mx-auto max-w-6xl px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-[#FAF8FD] border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Agency Co-Sell</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Offer certified Growcin campaign audits to prospective clients to close higher-tier marketing retainers.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#FAF8FD] border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">25% Recurring Share</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Earn 25% recurring commission on all software subscriptions generated through your agency referral code.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#FAF8FD] border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Dedicated Partner Support</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Direct Slack channel with our solutions engineering team and priority feature roadmap consideration.
              </p>
            </div>
          </div>
        </div>
