...
export default function AutoReplyAssistantPage() {
  return (
      ...
      <section className="relative overflow-hidden pt-36 pb-20 lg:pt-48 lg:pb-28 bg-[linear-gradient(180deg,#FBF9FF_0%,#FFFFFF_40%,#FBF9FE_100%)]">
        ...
        <div className="container relative z-10 mx-auto px-6 max-w-5xl text-center">
          ...
          <p className="mx-auto max-w-2xl text-lg sm:text-xl text-slate-600 leading-relaxed mb-10">
            Never miss an inbound customer inquiry. Our intelligent auto-reply assistant handles inquiries across WhatsApp, Instagram, and web chat simultaneously with zero latency.
          </p>
          ...
          >
            <span>Activate Auto Reply Free</span>
        ...
        <div className="container mx-auto max-w-6xl px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-[#FAF8FD] border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Sub-3 Second Replies</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Speed to lead determines conversion. The assistant acknowledges leads instantly when intent and attention are highest.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#FAF8FD] border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Contextual Responses</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                Adapts tone and answers based on which ad campaign or product page the lead arrived from.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#FAF8FD] border border-purple-100">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-2">Human Handoff</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                When a complex inquiry or VIP buyer asks to speak with a human rep, it alerts your team via WhatsApp and Slack immediately.
              </p>
            </div>
          </div>
        </div>
